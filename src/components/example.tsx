  ...
  return (
    <div className="bg-background flex min-h-0 w-full flex-1 flex-col">
      <div
        ...
        className={cn(
          'mx-auto grid min-h-0 w-full max-w-5xl min-w-0 flex-1 content-center items-start gap-8 p-4 pt-2 sm:gap-12 sm:p-6 md:grid-cols-2 md:gap-8 lg:p-12 2xl:max-w-6xl',
          className,
        )}
        {...props}
      />
